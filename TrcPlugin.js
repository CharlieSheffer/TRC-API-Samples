...
function LocalDebug() {
    $(function () {
        ...
        elemDiv.innerHTML = '<div style="background-color:lightyellow; border:dashed">' + '<h2>Self-hosted debugging</h2>' + '<p>View more doucmenation and samples at <a href="https://github.com/Voter-Science/TRC-API-Samples">https://github.com/Voter-Science/TRC-API-Samples</a></p>' + '<p>Enter your canvas code:</p>' + '<table>' + '<tr><td>Login URL</td><td><input size=80 type=text id="LocalDbgloginurl" value="https://trc-login.voter-science.com"/></td></tr>' + '<tr><td>Canvas code:</td><td><input type=text id="LocalDbgcode" placeholder="abc123" value="SGYZC4CH" /></td></tr>' + '</table>' + '<button onclick="LocalDebug_OnClick_AccessCodeAndLoadSheet()" value="Load">Load sheet!</button>' + '</div>';
...
// On startup
LocalDebug();
//# sourceMappingURL=TrcPlugin.js.map